<h1>Wellcome to Galaxy hideouts Website!</h1>
...
<p>&nbsp;</p>
<p>Get an account</p>
<form action="" method="POST"><input name="email" type="text" placeholder="Email" /> <input name="password" type="password" placeholder="Password" />
<div class="h-captcha" data-sitekey="your_site_key">&nbsp;</div>
<button class="g-recaptcha" data-sitekey="reCAPTCHA_site_key" data-callback="onSubmit" data-action="submit">Submit</button></form>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
